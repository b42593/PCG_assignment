...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=America&box=-120.043109,52.509212,-120.308781,52.347515
...
-----------
  ...
  * America Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * America Height Map (SRTM3 v4.1).png
  ...
  * America Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 652m (actual) is equal to 40m in
