...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Russia&box=24.071111,48.728722,23.825977,48.567026
...
-----------
  ...
  * Russia Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Russia Height Map (SRTM3 v4.1).png
  ...
  * Russia Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 643m (actual) is equal to 40m in
