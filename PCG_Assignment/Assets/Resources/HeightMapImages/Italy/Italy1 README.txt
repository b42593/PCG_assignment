...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Italy1&box=12.982456,42.993293,12.761388,42.831597
...
-----------
  ...
  * Italy1 Height Map (ASTER 30m).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Italy1 Height Map (SRTM3 v4.1).png
  ...
  * Italy1 Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 212m (actual) is equal to 40m in
