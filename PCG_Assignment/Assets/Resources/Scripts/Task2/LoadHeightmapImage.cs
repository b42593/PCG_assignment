...
public class LoadHeightmapImage : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        imageChosen = UnityEngine.Random.Range(0, heightMapImages.Length);
        heightMapImage = heightMapImages[imageChosen];

        fogParent = new GameObject("FogParent");
        cloudParent = new GameObject("CloudParent");

        waterHeight = UnityEngine.Random.Range(minWaterHeight, maxWaterHeight);
    ...
    void AddFog()
    {
        ...
        if (!fogObject)
        {
            ...
            {
                float xPos = UnityEngine.Random.Range(0, terrainData.size.x);
                float yPos = UnityEngine.Random.Range(280, 350);
                float zPos = UnityEngine.Random.Range(0, terrainData.size.z);
    ...
    void AddClouds()
    {
        ...
        if (!cloud)
        {
            ...
            {
                float xPos = UnityEngine.Random.Range(0, terrainData.size.x);
                float yPos = UnityEngine.Random.Range(500, 600);
                float zPos = UnityEngine.Random.Range(0, terrainData.size.z);
    ...
    {
        float xPos = UnityEngine.Random.Range(0, terrainData.size.x);
        float yPos = UnityEngine.Random.Range(652, terrainData.size.y);
        float zPos = UnityEngine.Random.Range(0, terrainData.size.z);
